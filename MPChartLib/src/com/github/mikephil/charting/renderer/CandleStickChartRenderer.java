    ...
    protected void drawDataSet(Canvas c, ICandleDataSet dataSet) {
        ...
        for (int j = minx,
            ...
            if (showCandleBar) {
                ...
                c.drawLines(mShadowBuffers, mRenderPaint);//画竖直线
            ...
            if (high == maxValue) {
                ...
                if (maxIndex > minIndex){
                    ...
                    c.drawText(highString, valuePostion[0] + highStringWidth/2, valuePostion[1]-highStringHeight/2,
                    mValuePaint);
            ...
            if (low == minValue) {
                ...
                if (maxIndex > minIndex){
                    ...
                    valuePostion[1] = low;
                    trans.pointValuesToPixel(valuePostion);
                    c.drawText(highString, valuePostion[0]+highStringWidth/2, valuePostion[1]+highStringHeight,
                    mValuePaint);
