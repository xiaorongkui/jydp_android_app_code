        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (xIndex <= deltaX && xIndex <= deltaX * mAnimator.getPhaseX()) {
                ...
                if (null != myMarkerViewH) {
                    ...
                    myMarkerViewH.draw(canvas, mViewPortHandler.contentLeft(), mIndicesToHighlight[i].getTouchY() -
                            myMarkerViewH.getHeight() / 2);
                }
                ...
                if (null != myMarkerViewLeft) {
                    ...
                    myMarkerViewLeft.draw(canvas, mViewPortHandler.contentLeft(), mIndicesToHighlight[i].getTouchY()
                            - myMarkerViewLeft.getHeight() / 2);
                ...
                if (null != myBottomMarkerView) {
                    ...
                    myBottomMarkerView.draw(canvas, pos[0] - myBottomMarkerView.getWidth() / 2, mViewPortHandler
                            .contentBottom());
                }
