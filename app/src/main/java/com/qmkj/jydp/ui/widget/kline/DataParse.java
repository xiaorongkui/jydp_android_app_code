...
public class DataParse {
    ...
    public void initLineDatas(ArrayList<KLineBean> datas) {
        ...
        for (int i = 0, j = 0; i < datas.size(); i++, j++) {
            ...
            barEntries.add(new BarEntry(i, datas.get(i).high, datas.get(i).low, datas.get(i).open, datas.get(i)
                    .close, datas.get(i).vol));
            candleEntries.add(new CandleEntry(i, datas.get(i).high, datas.get(i).low, datas.get(i).open, datas.get(i)
                    .close));
        }
    }
