...
public class EditItemView extends LinearLayout {
    ...
    private void initCustomAttr(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.EditItem);
        // 获取自定义属性资源ID
        mTopLineEnable = a.getBoolean(R.styleable.EditItem_topLine, false);
        mBottomLineEnable = a.getBoolean(R.styleable.EditItem_bottomLine, true);
        mLeftIconId = a.getResourceId(R.styleable.EditItem_leftIcon, -1);
        mLeftText = a.getText(R.styleable.EditItem_leftText);
        mLeftTextSize = a.getDimension(R.styleable.EditItem_leftTextSize, -1);
        mRightIconId = a.getResourceId(R.styleable.EditItem_rightIcon, R.mipmap.ic_common_arrow);
        mRightText = a.getText(R.styleable.EditItem_rightText);
        mRightTextSize = a.getDimension(R.styleable.EditItem_rightTextSize, -1);
        mLeftTextColorId = a.getColor(R.styleable.EditItem_leftTextColor, Color.parseColor("#33383b"));
        mRightTextColorId = a.getColor(R.styleable.EditItem_rightTextColor, Color.parseColor("#9d9d9d"));
        mRightIconEnable = a.getBoolean(R.styleable.EditItem_rightIconVisible_edit, true);
        a.recycle();
    }
