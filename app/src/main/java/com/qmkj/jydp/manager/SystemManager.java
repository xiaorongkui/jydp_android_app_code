...
public class SystemManager {
    ...
    public static void setStatusBarInvisible(RxAppCompatActivity context, boolean isShow) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (isShow) {
                ...
                setStatusBar(context, ResourcesManager.getColor(R.color.status_bar_color));
            } else {
    ...
    public static int getStatusBarHeight() {
        int resourceId = JYDPExchangeApp.getContext().getResources().getIdentifier("status_bar_height", "dimen",
                "android");
        return resourceId > 0 ? JYDPExchangeApp.getContext().getResources().getDimensionPixelSize(resourceId) : 0;
    }
