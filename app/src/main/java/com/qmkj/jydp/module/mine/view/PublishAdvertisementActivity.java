...
//        presenter.getUserCoinWithdrawalInfo(GET_CORN_CODE,false);
    ...
    protected void initTitle() {
        titleHeaderTv.setText(ResourcesManager.getString(R.string.publish_adversite));
    }
    ...
    protected void initView() {
        publishAdvertiseProportionEiv.setEditTextTextWatch(new MyTextWatcher(publishAdvertiseProportionEiv
                .getEditTextView(), 2));
    ...
    public void onSuccess(Object response, int tag) {
        ...
        switch (tag) {
            ...
            case SEND_REQUEST_SHELL:  //出售广告
                ...
                ActivityManager.startActivityForResult(mContext, intent, NEXT_ACTIVITY);
                break;
    ...
    private void initRecycleView() {
        ...
        paymentSelectDatas.add(new DialogItemBean(ResourcesManager.getString(R.string.bank_card_transfer), R
                .mipmap.bank_card, false));
        paymentSelectDatas.add(new DialogItemBean(ResourcesManager.getString(R.string.alipay_transfer), R
                .mipmap.alipay, false));
        paymentSelectDatas.add(new DialogItemBean(ResourcesManager.getString(R.string.wechat_transfer), R
        ...
        BaseRecycleAdapter recycleAdapter = new BaseRecycleAdapter<DialogItemBean>(R.layout
            ...
            protected void convert(BaseRecyclerViewHolder helper, DialogItemBean item, int position) {
                ImageView imageViewLeft = helper.getView(R.id.payment_type_left_iv);
                ImageView imageViewRight = helper.getView(R.id.payment_type_right_iv);
...
//        req.setAra(area);
    ...
    private void setCornDialog() {
        ...
        BaseRecycleAdapter adapter = new BaseRecycleAdapter<OtcCoinConfigRes.UserOtcCoinConfigListBean>(R.layout
                .bottom_select_item,
                data_corn) {

            @Override
            protected void convert(BaseRecyclerViewHolder helper, OtcCoinConfigRes.UserOtcCoinConfigListBean item,
                                   int position) {
...
//                        .bt_unselected);
    ...
    private void setTypeDialog() {
        ...
        tittle.setText("选择类型");
        recyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        BaseRecycleAdapter<DialogItemBean> adapter = new BaseRecycleAdapter<DialogItemBean>(R.layout
                .bottom_select_item, data_type
        ) {
            @Override
            protected void convert(BaseRecyclerViewHolder helper, DialogItemBean item, int position) {
//                ImageView imageViewRight = (ImageView) helper.getView(R.id.certify_type_right_iv);
...
//                        .bt_unselected);
    ...
    private void setCountryDialog() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        BaseRecycleAdapter<DialogItemBean> adapter = new BaseRecycleAdapter<DialogItemBean>(R.layout
                .bottom_select_item, data_country
        ) {
            @Override
            protected void convert(BaseRecyclerViewHolder helper, DialogItemBean item, int position) {
                TextView certifyType_tv = helper.getView(R.id.certify_type_tv);
