...
public class TransactionRecodeRecyAdapter extends XBaseAdapter<AccountRecordRes.DealRecordListBean> {
    ...
    protected void convert(XBaseViewHolder helper, AccountRecordRes.DealRecordListBean item) {
        TextView transaction_recode_name_tv = helper.getView(R.id.transaction_recode_name_tv); //名称
        TextView order_num = helper.getView(R.id.transsaction_order_num_tv); //订单号
        TextView recode_status = helper.getView(R.id.transaction_recode_status_tv); //买入
        TextView amount = helper.getView(R.id.entrustment_amount_tv); //数量
        TextView price = helper.getView(R.id.transaciton_price_tv); //单价
        TextView deal_amount = helper.getView(R.id.deal_amount_tv); //手续费
        TextView total_price = helper.getView(R.id.transaction_total_price_tv); //总价
        TextView actual_account = helper.getView(R.id.transaction_actual_account_tv); //实际到帐
        TextView time = helper.getView(R.id.transaction_time_tv); //完成时间

        TextView transaction_actual_account_title_tv = helper.getView(R.id.transaction_actual_account_title_tv); //实际到帐
        ...
        switch (item.getPaymentType()) {
            case 1:
                ...
                recode_status.setText(ResourcesManager.getString(R.string.buy_1));
                transaction_actual_account_title_tv.setText(ResourcesManager.getString(R.string.actual_account2_xt));
            ...
            case 2:
                ...
                transaction_actual_account_title_tv.setText(ResourcesManager.getString(R.string.actual_account_xt));
                recode_status.setText(ResourcesManager.getString(R.string.sell));
                break;
            case 3:
                text = "撤销";
                ...
                recode_status.setText(ResourcesManager.getString(R.string.cancel_order));
                break;
        }
