...
public class SystemMessageConfig {
    ...
    //交易面不能为空
    public static final int TRADE_PASS_NOT_BE_NULL_CODE = 100404;
    public static final String TRADE_PASS_NOT_BE_NULL_MESSAGE = "交易密码不能为空";
    /**
     * 交易中心和客服结束
     */
    ...
    //交易额度不能大于100万
    public static final int TRADE_NUM_MAX_CODE = 703016;
    public static final String TRADE_NUM_MAX_MESSAGE = "最高限额要小于100万";
    //挂单比例要小于一百万
    public static final int TRADE_MAX_PENDINGRATIO_CODE = 703017;
    public static final String TRADE_MAX_PENDINGRATIO_MESSAGE = "挂单比例要小于一百万";
    //最高限额过小
    public static final int TRADE_MAX_LIMIT_TOO_SMALL_CODE = 703018;
    public static final String TRADE_MAX_LIMIT_TOO_SMALL_MESSAGE = "最高限额过小";
    //最高限额要大于最低限额
    public static final int TRADE_MAX_LIMIT_LESS_THAN_MIN_LIMIT_CODE = 703019;
    public static final String TRADE_MAX_LIMIT_LESS_THAN_MIN_LIMIT_MESSAGE = "最高限额要大于最低限额";
    //订单类型错误
    public static final int TRADE_ORDER_TYPE_ERROR_CODE = 703020;
