...
import com.qmkj.syl.utils.download.entityhandler.EntityCallBack;
import com.qmkj.syl.utils.download.entityhandler.FileEntityHandler;
import com.qmkj.syl.utils.download.entityhandler.StringEntityHandler;
...
public class HttpHandler<T> extends AsyncTask<Object, Object, Object> implements EntityCallBack {
    ...
    protected void onProgressUpdate(Object... values) {
        ...
        switch (update) {
            ...
            case UPDATE_LOADING:
                if (callback != null)
                    callback.onLoading(Long.valueOf(String.valueOf(values[1])), Long.valueOf(String.valueOf
                            (values[2])));
                break;
            case UPDATE_FAILURE:
                if (callback != null)
