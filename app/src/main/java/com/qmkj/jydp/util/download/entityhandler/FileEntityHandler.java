 ...
 */
package com.qmkj.jydp.util.download.entityhandler;
...
public class FileEntityHandler {
    ...
    public Object handleEntity(HttpEntity entity, EntityCallBack callback, String target, boolean isResume) throws
            IOException {
